...
function Login(props) {
    ...
    useEffect(() => {
        ...
        if (localStorage.getItem('userReToken')) {
            ...
            axios.post('https://letscode-backend.onrender.com/check', params, config)
                .then(res => {
    ...
    const handleFPassCode = () => {
        ...
        if (!email) {
            ...
            axios.post("https://letscode-backend.onrender.com/checkuser&sendCode", userData)
                .then(function (res) {
    ...
    const handlePassChange = () => {
        ...
        {
            axios.post('https://letscode-backend.onrender.com/updatepassword',user)
                .then(function(res){
                    toast(res.data.message, {
                        position: "top-center",
                        autoClose: 2500,
    ...
    const login = () => {
        ...
        if (email && password) {
            axios.post("https://letscode-backend.onrender.com/login", user)
                .then(function (res) {
                    toast(res.data.message, {
                        position: "top-center",
                        autoClose: 2000,
