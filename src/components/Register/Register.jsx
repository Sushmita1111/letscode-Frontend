...
function Register() {
    ...
    const sendCode = async (e) => {
        ...
        if (name && email && checkPass(password) && password === confPassword) {
            ...
            axios.post("https://letscode-backend.onrender.com/emailverif", params, config)
                .then(function (res) {
    ...
    const register = (e) => {
        ...
        if (user.verificationCode === code) {
            ...
            axios.post("https://letscode-backend.onrender.com/register", params, config)
                .then(function (res) {
                    // let userinfo=res.data;
                    // navigate('/login')
                    toast("Welcome to letsCode " + res.data + ", Please Log In", {
                        position: "top-center",
                        autoClose: 3000,
                        hideProgressBar: false,
                        closeOnClick: true,
